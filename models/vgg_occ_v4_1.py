...
cfg = {
    ...
    'VGG19_v4_0': [64,'A', 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M', 512, 512, 512, 512, 'M'],
...
class VGG_OCC_v4_1(nn.Module):
    def __init__(self, vgg_name):
        super(VGG_OCC_v4_1, self).__init__()
        ...
        self.classifier_occluded = nn.Linear(64,2)
...
#                 print('np_M_shape:',np_M_shape)
                ...
                layers_A += [nn.Conv2d(64, 64, kernel_size=3, padding=1,stride = 4),
                           nn.BatchNorm2d(64),
                           nn.ReLU(inplace=True)]
                layers_A += [nn.MaxPool2d(kernel_size=2, stride=4)]
